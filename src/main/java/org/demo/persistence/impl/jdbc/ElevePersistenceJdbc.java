...
public class ElevePersistenceJdbc extends GenericDAO<EleveRecord> implements ElevePersistence,Serializable {
	...
	private final static String SQL_SELECT = 
		"select ID_ELEVE, NOM, PRENOM, EMAIL, PASSWORD, CODE_POSTAL, CODE_DEPARTEMENT, SEXE, DATE_INSCRIPTION from eleve where ID_ELEVE = ?";

	private final static String SQL_INSERT = 
		"insert into eleve ( ID_ELEVE, NOM, PRENOM, EMAIL, PASSWORD, CODE_POSTAL, CODE_DEPARTEMENT, SEXE, DATE_INSCRIPTION ) values ( ?, ?, ?, ?, ?, ?, ?, ?, ? )";

	private final static String SQL_UPDATE = 
		"update eleve set NOM = ?, PRENOM = ?, EMAIL = ?, PASSWORD = ?, CODE_POSTAL = ?, CODE_DEPARTEMENT = ?, SEXE = ?, DATE_INSCRIPTION = ? where ID_ELEVE = ?";
	...
	protected void setValuesForInsert(PreparedStatement ps, int i, EleveRecord eleve) throws SQLException {
		...
		setValue(ps, i++, eleve.getCodeDepartement() ) ; // "CODE_DEPARTEMENT" : java.lang.Integer
	...
	protected EleveRecord populateBean(ResultSet rs, EleveRecord eleve) throws SQLException {
		...
		eleve.setCodeDepartement(rs.getInt("CODE_DEPARTEMENT")); // java.lang.Integer
		if ( rs.wasNull() ) { eleve.setCodeDepartement(null); }; // not primitive number => keep null value if any
